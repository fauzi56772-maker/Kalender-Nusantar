...
// DATA HARI LIBUR NASIONAL INDONESIA 2026 (Format: "Tanggal-Bulan")
const HOLIDAYS = {
    "1-1": "Tahun Baru Masehi",
    "16-1": "Isra' Mi'raj Nabi Muhammad SAW",
    "16-2": "Tahun Baru Imlek",
    "17-2": "Libur Lanjutan Terkait Imlek",
    "18-3": "Cuti Bersama Hari Suci Nyepi",
    "19-3": "Hari Suci Nyepi (Tahun Baru Saka)",
    "20-3": "Cuti Bersama Idulfitri",
    "21-3": "Hari Raya Idulfitri (1 Syawal)",
    "22-3": "Hari Raya Idulfitri Kedua",
    "23-3": "Cuti Bersama Idulfitri",
    "24-3": "Cuti Bersama Idulfitri",
    "3-4": "Jumat Agung (Wafat Yesus Kristus)",
    "5-4": "Paskah (Kebangkitan Yesus Kristus)",
    "1-5": "Hari Buruh Internasional",
    "14-5": "Kenaikan Yesus Kristus",
    "15-5": "Cuti Bersama Kenaikan Yesus Kristus",
    "27-5": "Hari Raya Idul Adha",
    "28-5": "Cuti Bersama Idul Adha",
    "31-5": "Hari Raya Waisak",
    "1-6": "Hari Lahir Pancasila",
    "16-6": "1 Muharram / Tahun Baru Islam",
    "17-8": "Hari Kemerdekaan Republik Indonesia",
    "29-10": "Maulid Nabi Muhammad SAW",
...
// Format Hijriyah dengan Fitur Koreksi -1 Hari untuk Indonesia
function getHijriyahFormat(date) {
    try {
        // Ambil duplikasi objek tanggal asli
        const adjustedDate = new Date(date.getTime());
        // Kurangi 1 hari agar sinkron dengan penanggalan Hilal/Kemenag RI 2026
...
function updateSidebar(date) {
    ...
    if (masehiEl) {
        // Tampilkan nama hari besar jika tanggal yang diklik adalah hari libur nasional
        masehiEl.innerHTML = date.toLocaleDateString('id-ID', options) + 
            (holidayName ? `<br><span style="color:var(--danger-red); font-size:1rem; font-weight:600;">${holidayName}</span>` : '');
    }
